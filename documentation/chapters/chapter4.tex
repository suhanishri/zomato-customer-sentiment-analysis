...
\small
\begin{tabular}{L{0.27\textwidth}C{0.14\textwidth}C{0.16\textwidth}C{0.16\textwidth}C{0.14\textwidth}}
\toprule
...
\small
\begin{tabular}{L{0.27\textwidth}C{0.14\textwidth}C{0.15\textwidth}L{0.28\textwidth}}
\toprule
...
\small
\begin{tabular}{L{0.27\textwidth}C{0.15\textwidth}C{0.16\textwidth}C{0.14\textwidth}C{0.14\textwidth}}
\toprule
...
\begin{table}[h]
\centering
\caption{Structured Comparison for the Prior Benchmark Study and the Current Project Models}
\small
\begin{tabular}{L{0.24\textwidth}L{0.22\textwidth}L{0.18\textwidth}L{0.20\textwidth}}
\toprule
\textbf{Comparison Dimension} & \textbf{Paper-Reported Random Forest} & \textbf{Recreated TF-IDF + Random Forest} & \textbf{SentiLens (TF-IDF + Logistic Regression)} \\
\midrule
Study source & Jonathan et al. (2019) & Current project benchmark & Current project final model \\
...
Role in comparison & Literature reference point & Paper-style internal benchmark & Best-performing final model \\
Accuracy & 92.44\% & 88.58\% & 90.17\% \\
Average precision & 0.9300 & 0.6519 & 0.6771 \\
Average recall & 0.8700 & 0.6135 & 0.6868 \\
Interpretation & Published benchmark result & Closest recreation of the paper model direction on our data & Final selected model used for scoring and dashboard interpretation \\
\bottomrule
\end{tabular}
\normalsize
\end{table}
...
\begin{table}[h]
\centering
\caption{Chapter 4 Results Takeaway Summary}
\small
\begin{tabular}{L{0.22\textwidth}L{0.26\textwidth}L{0.32\textwidth}}
\toprule
\textbf{Analytical Area} & \textbf{Main Result} & \textbf{Managerial Meaning} \\
\midrule
Overall sentiment & Positive and negative sentiment are both substantial & Brand perception is mixed and requires theme-level interpretation \\
Refund and cancellation & Highest negativity and highest priority score & Most urgent service recovery and trust-related issue \\
Delivery & Largest theme by volume with meaningful negative load & Highest operational exposure area \\
Customer support & Strongly negative sentiment concentration & Weakness in issue resolution and service recovery \\
App experience & Strong positive pattern & Relative digital strength worth preserving \\
Benchmark comparison & SentiLens outperforms recreated TF-IDF + Random Forest & Final model is more suitable for downstream business analysis \\
Competitor comparison & Zomato performs better than Swiggy on brand-level sentiment & Relative market strength exists, but major pain points still remain \\
\bottomrule
\end{tabular}
\normalsize
\end{table}
